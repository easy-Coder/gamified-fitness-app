...
class WorkoutCompleteScreen extends ConsumerStatefulWidget {
  const WorkoutCompleteScreen({super.key, required this.workoutLog});
...
class _WorkoutCompleteScreenState extends ConsumerState<WorkoutCompleteScreen> {
  ...
  Duration workoutDuration = Duration(seconds: 20, minutes: 40, hours: 2);
  late final WorkoutLog log;
