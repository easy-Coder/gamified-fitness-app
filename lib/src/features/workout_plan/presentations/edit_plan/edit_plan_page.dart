...
typedef EditPlanRecord =
    ({WorkoutPlanData workoutPlan, List<WorkoutExercise> exercises});
...
class EditPlanPage extends ConsumerStatefulWidget {
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _EditPlanPageState(editPlanRecord.workoutPlan, editPlanRecord.exercises);
}
...
class _EditPlanPageState extends ConsumerState<EditPlanPage> {
  ...
  void initState() {
    ...
    workOutNameController = TextEditingController(text: workoutPlan.name);
                        ...
                        ShadButton.destructive(
                          onPressed: () {
                            ...
                            if (workouts.containsAll(
                                ...
                                widget.editPlanRecord.exercises.containsAll(
                                  workouts,
                                  (e, o) => e == o,
                                )) {
                              exerciseIsDirty = false;
      ...
      floatingActionButton:
          (nameIsDirty || dayIsDirty || exerciseIsDirty)
              ? ConstrainedBox(
                ...
                child: PrimaryButton(onTap: () {}, title: 'Submit'),
              )
              : null,
